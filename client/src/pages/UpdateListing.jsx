...
export default function UpdateListing() {
  ...
  return (
    <section className="max-w-7xl mx-auto w-full px-5 py-12 sm:py-20 ">
      <h1 className="text-3xl mb-4 font-tenor text-center">Update Listing</h1>
      <form
      ...
      >
        ...
        <div className="flex flex-col flex-1">
          ...
          <button
            ...
            className="py-2 px-6 w-full bg-green-600 hover:opacity-80 text-white mt-4 h-12 rounded"
          >
