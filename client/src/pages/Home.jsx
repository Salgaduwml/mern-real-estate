...
export default function Home() {
  ...
  return (
    <>
      <section className="w-full py-24 sm:py-40 px-5 bg-cover bg-center flex flex-col-reverse sm:flex-row relative items-center justify-center bg-[url(https://images.unsplash.com/photo-1633109741715-59b57495bbdc?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] after:bg-black/30 after:absolute after:inset-0">
        <div className="max-w-3xl flex flex-col z-[20] justify-center items-center gap-6">
          <h1 className="font-tenor text-white text-4xl sm:text-6xl text-center leading-[1.2]">
            Find Your Next{" "}
      ...
      <section className="max-w-7xl mx-auto px-5 py-12 sm:py-16">
        <div className="flex gap-4 justify-between items-center">
          <h2 className="font-tenor text-2xl sm:text-3xl">Latest Offers</h2>
      ...
      <section className="py-12 sm:py-16 bg-red-600/5">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-7xl mx-auto px-5">
      ...
      <section className="max-w-7xl mx-auto px-5 py-12 sm:py-16">
        <div className="flex gap-4 justify-between items-center">
          <h2 className="font-tenor text-2xl sm:text-3xl">Recent Listings</h2>
      ...
      <section className="w-full bg-fixed h-[320px] sm:h-[480px] bg-cover bg-center flex flex-col-reverse sm:flex-row relative items-center justify-center bg-[url(https://images.unsplash.com/photo-1592928302636-c83cf1e1c887?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] after:bg-black/30 after:absolute after:inset-0">
        <div className="max-w-3xl flex flex-col z-[20] justify-center items-center gap-6">
          <h1 className="font-tenor text-white text-3xl sm:text-5xl text-center leading-[1.2]">
            Need a home loan?
            <br />
            Get pre-approved
          </h1>
